                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <select required=""  id="ctrl-id_posto" data-load-path="<?php print_link('api/json/tb_aldeia_id_posto_option_list') ?>" data-load-select-options="id_suco" name="id_posto"  placeholder="Select a value ..."    class="custom-select" >
                                                        <?php
                                                        $rec = $data['id_posto'];
                                                        $id_posto_options = $comp_model -> tb_aldeia_id_posto_option_list($data['id_municipiu']);
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <select required=""  id="ctrl-id_suco" data-load-path="<?php print_link('api/json/tb_aldeia_id_suco_option_list') ?>" name="id_suco"  placeholder="Select a value ..."    class="custom-select" >
                                                        <?php
                                                        $rec = $data['id_suco'];
                                                        $id_suco_options = $comp_model -> tb_aldeia_id_suco_option_list($data['id_posto']);
